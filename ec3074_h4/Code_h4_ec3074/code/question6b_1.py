...
fp = open("output/tag_dev6_1.out", "w")
...
def ComputeFeatures(enum_histories, sentence):
  ...
  for item in history_list:
    ...
    if(len(elements) == 3):  
      ...
      weight[(elements[0], elements[1], elements[2])] = weight1 + weight2 + weight3 + tempweight1
...
if __name__ == '__main__':
  initializeWeights("tag.model", "output/suffix_tagger6_1.model")
